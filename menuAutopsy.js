...
var arr_Decomposition = [
  ...
  'Кожный покров теплый на ощупь в подмышечных впадинах и внутренних поврехностях бедер, ',
  'Кожный покров тепловатый на ощупь по всем поверхностям тела, ',
  'Кожный покров тепловатый на ощупь в подмышечных впадинах и внутренних поврехностях бедер, ',
...
var arr_headbrain = [
    ...
    'сосуды ее расширены, полнокровеные. ',
...
var arr_visceralGeneral = [
    ...
    'Общее расположение органов брюшной полости правильное. Большой сальник розовато-желтого цвета, частично закрывает петли кишечника. Брюшина гладкая, влажная, полупрозрачная, белесовато-серого цвета, без повреждений. Спаек, сращений и посторонней жидкости в  брюшной полости не обнаружено. Червеорбразный отросток не изменен, совободно расположен на своей брыжейке. ',
    ...
    'Клетчатка переднего и заднего средостенияне не изменена, без кровоизлияний. Сердечная сорочка розовато-серого цвета, гладкая, блестящая, внутренняя поверхность ее гладкая, в полости сердечной сорочки 10 мл желтоватой прозрачной жидкости. Кровоизлияний в области сосудисто-нервных пучков шеи не обнаружено. Ход магистральных артерий шеи не нарушен. В просветах яремных вен и сонных артерий следы жидкой темно-красной крови. ',
    ...
    'Слизистая языка бледно-розовая, в области спинки обложена светло-буроватым налетом, сосочки ее выражены хорошо, мышцы языка на разрезе красновато-коричневые, без рубцов и кровоизлияний; язычная миндалина не увеличена, бледно-синюшная. Вход в гортань и глотку свободен, голосовая щель зияет. Подъязычная кость и хрящи гортани без повреждений, кровоизляний в мягких тканях вокруг них нет.   ',
...
var arr_lungs = [
    ...
    'В правой плеврельной полости ', /*5*/
    'В левой плеврельной полости ',
    'в левой постороней жидкости не обнаружено. ',
    'в правой постороней жидкости не обнаружено. ',
...
var arr_heartVessels = [
    ...
    'Внутренняя оболочка сердца полупрозрачная, красновато-серого цвета, гладкая, тонкая, без кровоизляний. ',
    'Мышца сердца на разрезах красновато-коричневого цвета, ',
    ' с мелкими сероватыми прослойками, расположенными хаотично по всей сердечной мыщце. ',
...
var arr_LienGsr = [
    'Селезенкка обычной формы, мягкой консистенции, серо-красного цвета, поверхность гладкая, капсула не напряжена. ',
    'Масса селезенки: ',
...
function getResult(t) {
    ...
    var visceralGeneral = {
        ...
        thoracicCavity: function(){
            return ' ^start^ ' + t.array10[10] + ' ^end^';
            //+ ' ^end^ array11:   ' + t.array10[11] + 'end array 11'
        },
